  ...
  return (
    <section className="rounded-2xl border border-zinc-800 bg-[#111111]/90 p-6">
      <div className="mb-5 flex items-center justify-between gap-3">
        <p className="text-xs uppercase tracking-widest text-zinc-400">Pricing Suggestion</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-zinc-800 bg-[#0d0d0d] p-5">
          <p className="mb-2 text-xs uppercase tracking-widest text-zinc-400">Free Tier</p>
          <p className="text-sm leading-7 text-zinc-200">{pricing.free_tier}</p>
        </div>
        <div className="rounded-xl border border-zinc-800 bg-[#0d0d0d] p-5">
          <p className="mb-2 text-xs uppercase tracking-widest text-zinc-400">Paid Tier</p>
          <p className="text-sm leading-7 text-zinc-200">{pricing.paid_tier}</p>
        </div>
      </div>
